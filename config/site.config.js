...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'exzdshhh@outlook.com',
  ...
  protectedRoutes: ['/🍉 Others/🔒 Secrets', '/🍉 Others/😎'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:chanshuwork@outlook.com',
